...
@MainActor
public class QTableWidgetItem : QObject{
	convenience init (_ string: String?) {
		self.init ()
		objectID = Conduit.tableWidgetItemNew (string ?? "")
	...
	public func setForeground (_ color: QColor) {
		if let objectID = objectID {
			return Conduit.tableWidgetItemSetForeground (objectID, color)
		} 
	}
	public func setBackground (_ color: QColor) {
		if let objectID = objectID {
			return Conduit.tableWidgetItemSetBackground (objectID, color)
		} 
	}
	public func setFlags (_ flags: Int) {
		// TODO
	}
